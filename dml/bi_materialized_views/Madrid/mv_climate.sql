CREATE MATERIALIZED VIEW mv_bi_madrid_daily_avg_temperature_projection AS
 select
 ...
 CREATE MATERIALIZED VIEW mv_bi_madrid_avg_temperature_projection AS
select 
  x.scenario,
  case
...
from mv_bi_madrid_daily_avg_temperature_projection bi
group by 
